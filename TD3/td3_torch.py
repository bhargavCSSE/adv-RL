...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau, env, gamma=0.99, 
        ...
        self.critic_1 = CriticNetwork(beta, input_dims, layer1_size, layer2_size, n_actions,  name='critic_1')
        self.critic_2 = CriticNetwork(beta, input_dims, layer1_size, layer2_size, n_actions,  name='critic_2')
    ...
    def learn(self):
        ...
        q2_ = self.target_critic_2.forward(state, target_actions)
    ...
    def update_network_parameters(self, tau=None):
        ...
        target_actor_params = self.target_critic_1.named_parameters()
